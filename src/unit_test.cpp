...
TEST(HW1Test, ZEROS) {
    algebra::Matrix matrix{algebra::zeros(5, 6)};
...
TEST(HW1Test, ONES) {
    algebra::Matrix matrix{algebra::ones(7, 3)};
...
TEST(HW1Test, RANDOM1) {
    ...
    algebra::Matrix matrix{algebra::random(4, 4, -5, 7)};
...
TEST(HW1Test, MULTIPLY1) {
    algebra::Matrix matrix{algebra::random(3, 4, -4, 2)};
    algebra::Matrix mult{algebra::multiply(matrix, 3.5)};
...
TEST(HW1Test, MULTIPLY2) {
    ...
    algebra::Matrix matrix{algebra::multiply(algebra::Matrix{}, algebra::Matrix{})};
    EXPECT_TRUE(matrix.empty());

    // Caution: matrices with wrong dimensions cannot be multiplied
    EXPECT_THROW(algebra::multiply(algebra::Matrix{{1, 2, 3}, {4, 5, 6}}, algebra::Matrix{{1, 2, 3}, {4, 5, 6}}), std::logic_error);
}

TEST(HW1Test, MULTIPLY3) {
    algebra::Matrix matrix1{{-3, 3, 1.7}, {4, -4, 2.6}, {-5, 5, 3.5}};
    algebra::Matrix matrix2{{2.5}, {-2}, {-5.5}};
    algebra::Matrix matrix{algebra::multiply(matrix1, matrix2)};
...
TEST(HW1Test, MULTIPLY4) {
    algebra::Matrix matrix1{{-3, 2, 1.7}, {4, -5, 2.6}, {7.2, 5, 3.5}};
    algebra::Matrix matrix2{{6.5}, {-2}, {-5}};
    algebra::Matrix matrix{algebra::multiply(matrix1, matrix2)};
...
TEST(HW1Test, SUM1) {
    ...
    EXPECT_TRUE(algebra::sum(algebra::Matrix{}, 1.5).empty());

    algebra::Matrix matrix{algebra::random(2, 5, 0, 4)};
    algebra::Matrix sum{algebra::sum(matrix, 2.44)};
...
TEST(HW1Test, SUM2) {
    ...
    EXPECT_TRUE(algebra::sum(algebra::Matrix{}, algebra::Matrix{}).empty());

    // Caution: matrices with wrong dimensions cannot be summed
    EXPECT_THROW(algebra::sum(algebra::Matrix{{1, 2, 3}}, algebra::Matrix{}), std::logic_error);

    algebra::Matrix matrix1{algebra::random(3, 2, -1, 4)};
    algebra::Matrix matrix2{algebra::random(3, 2, -8, -3)};
    algebra::Matrix sum{algebra::sum(matrix1, matrix2)};
...
TEST(HW1Test, TRANSPOSE) {
    ...
    EXPECT_TRUE(algebra::transpose(algebra::Matrix{}).empty());

    algebra::Matrix matrix{algebra::random(3, 5, -2, 5)};
    algebra::Matrix transpose = algebra::transpose(matrix);
...
TEST(HW1Test, MINOR1) {
    algebra::Matrix matrix{{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
    algebra::Matrix minor = algebra::minor(matrix, 1, 2);
...
TEST(HW1Test, MINOR2) {
    algebra::Matrix matrix{{7, 2.5, 3.1}, {4.2, 5, 10.4}, {70.7, 8, 0}};
    algebra::Matrix minor = algebra::minor(matrix, 1, 1);
...
TEST(HW1Test, DETERMINANT1) {
    ...
    EXPECT_EQ(algebra::determinant(algebra::Matrix{}), 1);

    // Caution: non-square matrices have no determinant
    EXPECT_THROW(algebra::determinant(algebra::Matrix{{1, 2, 3}, {4, 5, 6}}), std::logic_error);

    // test case
    algebra::Matrix matrix{{-1, 1.5, -1.75, -2}, {-2, 2.5, -2.75, -3}, {3, 3.5, -3.75, -4}, {4, 4.5, 4.75, -5}};
...
TEST(HW1Test, INVERSE1) {
    ...
    EXPECT_TRUE(algebra::inverse(algebra::Matrix{}).empty());

    // Caution: non-square matrices have no inverse
    EXPECT_THROW(algebra::inverse(algebra::Matrix{{1, 2, 3}, {40, 5, -6}}), std::logic_error);

    // Caution: singular matrices have no inverse
    algebra::Matrix non_singular_matrix{{1, 1.5, -1.75, 2}, {2, 2.5, -2.75, 3}, {3, 3.5, -3.75, 4}, {4, 4.5, 4.75, 5}};
    EXPECT_THROW(algebra::inverse(non_singular_matrix), std::logic_error);

    // test case
    algebra::Matrix matrix{{-1, 1.5, -1.75, -2}, {-2, 2.5, -2.75, -3}, {3, 3.5, -3.75, -4}, {4, 4.5, 4.75, -5}};
    algebra::Matrix inverse{algebra::inverse(matrix)};
...
TEST(HW1Test, INVERSE2) {
    // test case
    algebra::Matrix matrix{{-12, 1.5, -1.75, -2}, {-2, 2.5, -2.75, -3}, {25, 3.5, -3.75, -4}, {4, 4.5, 4.75, -51}};
    algebra::Matrix inverse{algebra::inverse(matrix)};
...
TEST(HW1Test, CONCATENATE1) {
    ...
    EXPECT_THROW(algebra::concatenate(algebra::Matrix{{1, 2}}, algebra::Matrix{{1, 2, 3}, {4, 5, 6}}, 0), std::logic_error);

    // test case
    algebra::Matrix matrix1{algebra::random(2, 3, 0, 1)};
    algebra::Matrix matrix2{algebra::random(4, 3, 0, 1)};
    algebra::Matrix matrix{algebra::concatenate(matrix1, matrix2, 0)};
...
TEST(HW1Test, CONCATENATE2) {
    // Caution: matrices with wrong dimensions cannot be concatenated
    EXPECT_THROW(algebra::concatenate(algebra::Matrix{{1, 2}}, algebra::Matrix{{1, 2, 3}, {4, 5, 6}}, 1), std::logic_error);

    // test case
    algebra::Matrix matrix1{algebra::random(2, 3, 0, 1)};
    algebra::Matrix matrix2{algebra::random(2, 1, 0, 1)};
    algebra::Matrix matrix{algebra::concatenate(matrix1, matrix2, 1)};
...
TEST(HW1Test, ERO_SWAP) {
    ...
    EXPECT_THROW(algebra::ero_swap(algebra::Matrix{{1, 2}}, 0, 1), std::logic_error);

    // test case
    algebra::Matrix matrix{algebra::random(4, 3, 0, 4)};
    algebra::Matrix swap{algebra::ero_swap(matrix, 2, 3)};
...
TEST(HW1Test, ERO_MULTIPLY) {
    algebra::Matrix matrix{algebra::random(4, 3, 0, 4)};
    algebra::Matrix ero{algebra::ero_multiply(matrix, 2, 1.5)};
...
TEST(HW1Test, ERO_SUM) {
    algebra::Matrix matrix{algebra::random(4, 3, 0, 4)};
    algebra::Matrix ero{algebra::ero_sum(matrix, 0, 2, 3)};
...
TEST(HW1Test, UPPER_TRIANGULAR1) {
    ...
    EXPECT_TRUE(algebra::upper_triangular(algebra::Matrix{}).empty());

    // Caution: non-square matrices have no upper triangular form
    EXPECT_THROW(algebra::upper_triangular(algebra::Matrix{{1, 2, 3}, {4, 5, 6}}), std::logic_error);

    // test case 1
    algebra::Matrix matrix1{{1, 2}, {5, 7}};
    algebra::Matrix res1{algebra::upper_triangular(matrix1)};
    EXPECT_NEAR(res1[0][0], 1, 0.03);
    EXPECT_NEAR(res1[1][0], 0, 0.03);
    EXPECT_NEAR(res1[1][1], -3, 0.03);

    // test case 2
    algebra::Matrix matrix2{{1, 2, 3}, {4, 7, 5}, {6, 1, 3}};
    algebra::Matrix res2{algebra::upper_triangular(matrix2)};
...
TEST(HW1Test, BONUS) {
    // test case
    algebra::Matrix matrix2{{0, 2, 3}, {4, 7, 5}, {6, 1, 3}};
    algebra::Matrix res2{algebra::upper_triangular(matrix2)};
